...
class IdleTest {
	...
	// code
	@Test
	@DisplayName("Design Pattern: Should maintain a single global instance (Singleton)")
	...
	@Test
	@DisplayName("Transition: 'Up' event should remain in Idle if timer memory is zero")
	...
	@Test
	@DisplayName("State Logic: Returning to Idle after setting time should update memory values")
	...
	@Test
	@DisplayName("Transition: 'Right' event should move state from Idle to SetTimer")
	void testRight() {
	...
	@Disabled
	@DisplayName("Transition: 'Left' event handling (Inherited from Superclass)")
	void testLeft() {
		/*
