...
class StopwatchTests {
	...
	@Test
	@DisplayName("Initialization: Should start in 'Stopwatch' mode with zeroed total/lap times")
	...
	@Test
	@DisplayName("Design Pattern: AbstractStopwatch entry point should default to ResetStopwatch")
	...
	@Test
	@DisplayName("State Persistence: Switching to Timer and back should return to the original Stopwatch state (History Pattern)")
