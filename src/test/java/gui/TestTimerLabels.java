...
class TestTimerLabels extends TestGUIAbstract {
	...
	@Test
	@DisplayName("UI Label Integration Tests")
	...
	@Test
	@DisplayName("Timer: Initial 'Idle' state should show run/set/mode options")
	...
	@Test
	@DisplayName("Timer: 'Set' mode should update buttons to configuration controls (reset/inc 5/done)")
	...
	@Test
	@DisplayName("Stopwatch: Default state should show 'run' and 'change mode'")
	...
	@Test
	@DisplayName("Stopwatch: 'Running' state should switch buttons to 'split' and 'reset'")
