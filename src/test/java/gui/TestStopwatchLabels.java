...
class TestStopwatchLabels extends TestGUIAbstract {
	...
	@Test
	@DisplayName("Stopwatch: Should initialize UI in 'Reset' state with 'run' and 'change mode' options")
	void testStopwatch1() {
	...
	@Test
	@DisplayName("Stopwatch: Should transition to 'Running' state and update buttons to 'split' and 'reset'")
	void testStopwatch2() {
		c.left(); // simulate clicking on the left button
